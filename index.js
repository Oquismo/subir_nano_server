...
const comentarios = require("./router/comentariosRouter");  // Asegurándonos de que esta ruta esté incluida
...
app.use("/comentarios", comentarios);  // Aquí agregamos la ruta para los comentarios
